...
//*-- IoT Information
#define SSID    "Lab601_2.4G"    //   "路由器名稱"
#define PASS    "NTUTCC601"    //   "路由器連線密碼"
#define HOST    "api.thingspeak.com" // ThingSpeak IP Address: 184.106.153.149
#define PORT    80
#define READAPIKEY  "RN742J8HOPJLODER"  // READ APIKEY for the CHANNEL_ID     // LFYPHMKTEDT62J1P
...
void loop() {
    ...
    // 每隔多久取一次資料
    retrieveField( 202410, 1 );  // filed_id=1 是 DHT11 的溫度值
    delay( 15000 ); // ms
}
